...
from clients.model import GoogLeNet
...
def main():
    ...
    train_dataset = datasets.ImageFolder(root="/home/dnlab/Data-B/data/main_data/train_cat",
    ...
    validate_dataset = datasets.ImageFolder(root="/home/dnlab/Data-B/data/main_data/val_cat",
    ...
    net = GoogLeNet(num_classes=35, aux_logits=True, init_weights=True)
    net.to(device)
